...
export default function PacientesPage() {
  ...
  const filteredPacientes = useMemo(() => {
    ...
    const filtrados = pacientes.filter((p) => {
      ...
      // Se eliminó el filtro por estado
      ...
      return matchSearch && matchArt && matchCompletitud;
    });
    ...
    pacientes, searchTerm, filtroArt, filtroCompletitud,
  ...
  return (
    <main className={styles.container}>
      ...
      {/* Tabs de vista SIN filtro de estado */}
      <nav className={styles.viewTabs} style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
        ...
        {/* Se eliminó el switch de filtro de estado */}
      </nav>
          ...
          {filteredPacientes.length === 0 ? (
            ...
            <section className={styles.tableWrapper}>
              <table className={styles.table}>
                ...
                <thead>
                  <tr>
                    {[["nombre","Paciente"],["dni","DNI"],["edad","Edad"],["art","ART"],["nroSiniestro","N° Siniestro"],["fechaIngreso","Ingreso"]].map(([key,label]) => (
