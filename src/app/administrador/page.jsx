...
export default function AdminDashboard() {
  ...
  const cards = [
    { title: "Pacientes", value: stats.pacientes, icon: Users, color: "#44794d", href: "/administrador/pacientes" },

    { title: "Med + Descartables", value: stats.medDesc, icon: Pill, color: "#7c3aed", href: "/administrador/med-descartables" },
...
{ title: "Historias clinicas", value: stats.historias, icon: BookOpen, color: "#14b8a6", href: "/administrador/historia-clinica" }, 
  ...
  const recentGroups = [
    { title: "Fojas quirurgicas cargadas", href: "/administrador/cx/foja/medicos", items: recent.fojas },
    /* { title: "Historias clinicas", href: "/historia-clinica", items: recent.historias }, */
    { title: "Facturacion reciente", href: "/administrador/Facturacion/Facturados", items: recent.facturas },
  ];
