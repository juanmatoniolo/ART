...
export default function DocumentosModal({ paciente, onClose, onUpdated }) {
    ...
    const [printing, setPrinting] = useState(null); // null | "documentacion" | "dorso"
    ...
    /* =========================================================
       Imprimir Documentación = FORMULARIO (INT) + FOTOS
       ========================================================= */
    ...
    /* =========================================================
       Imprimir DORSO (hoja 1 de DORSO-CX.pdf con nombre del paciente)
       ========================================================= */
