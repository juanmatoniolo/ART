...
export default function HistoriasClinicasPage() {
  ...
  const [formGeneral, setFormGeneral] = useState({ nombre_apellido: "", dni: "" });
  const [formUti, setFormUti] = useState({ nombre_apellido: "", dni: "" });
  ...
  const filteredItems = useMemo(
    () => filterItems({ items: currentItems, searchTerm, searchField, showOnlyAlerts }),
  ...
  if (loading) {
    return <div className={styles.container}>Cargando historias clínicas...</div>;
  }
