...
export default function SolicitudesCirugia() {
  ...
  return (
    <div className={styles.container}>
      ...
      {/* Filtros internos de la tabla (todas/pendientes/atendidas) */}
        ...
        <div className={styles.modalOverlay} onClick={() => setSelected(null)}>
          <div className={styles.modal} onClick={(e) => e.stopPropagation()}>
            ...
            <div className={styles.modalBody}>
              ...
              {selected.atendida && <div className={styles.detailRow}><strong>Fecha de atención:</strong> {new Date(selected.fechaAtendida).toLocaleString("es-AR")}</div>}
            </div>
          </div>
        </div>
      )}

      {/* Modal para cargar cirugía (sin cambios) */}
          ...
          <div className={styles.modal} onClick={(e) => e.stopPropagation()}>
            ...
            <div className={styles.modalBody}>
              <div className={styles.formGroup}>
                ...
                <input type="text" className={styles.input} value={cirugiaForm.cirugia} onChange={(e) => setCirugiaForm({ ...cirugiaForm, cirugia: e.target.value })} placeholder="Ej: Colecistectomía laparoscópica" />
              </div>
              <div className={styles.formGroup}>
                <label className={styles.label}>Médico cirujano *</label>
                <input type="text" className={styles.input} value={cirugiaForm.medico} onChange={(e) => setCirugiaForm({ ...cirugiaForm, medico: e.target.value })} placeholder="Nombre del profesional" />
              </div>
              <div className={styles.formGroup}>
                <label className={styles.label}>ART / Obra Social</label>
                <input type="text" className={styles.input} value={cirugiaForm.art} onChange={(e) => setCirugiaForm({ ...cirugiaForm, art: e.target.value })} placeholder="Opcional" />
              </div>
              <div className={styles.formGroup}>
                <label className={styles.label}>Fecha estimativa de cirugía *</label>
                <input type="date" className={styles.input} value={cirugiaForm.fechaEstimada} onChange={(e) => setCirugiaForm({ ...cirugiaForm, fechaEstimada: e.target.value })} />
              </div>
              <div className={styles.actionsModal}>
                <button className={styles.cancelBtn} onClick={() => setShowCirugiaModal(false)} disabled={saving}>Cancelar</button>
                <button className={styles.saveBtn} onClick={handleGuardarCirugia} disabled={saving}>{saving ? "Guardando..." : "Guardar cirugía"}</button>
              </div>
            </div>
          </div>
        </div>
