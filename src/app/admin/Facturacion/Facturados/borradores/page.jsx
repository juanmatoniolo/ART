...
export default function BorradoresPage() {
    ...
    useEffect(() => {
        const r = ref(db, 'Facturacion/index/borradores');
        return onValue(
            r,
            (snap) => {
        ...
        <div className={stylesBase.container}>
            <header className={stylesBase.header}>
                <div className={stylesBase.titleBlock}>
                    <h1 className={stylesBase.title}>📝 Borradores</h1>
                    <p className={stylesBase.subtitle}>Retomá una carga guardada.</p>
                </div>
            </header>
                                ...
                                <div key={it.id} className={styles.card}>
                                    ...
                                    <div className={styles.actions}>
                                        <Link
                                            ...
                                            href={`/admin/facturacion/nuevo?draft=${it.id}&art=${it.artKey}`}
                                        >
                                            ▶ Retomar
                                        </Link>
                                    </div>
